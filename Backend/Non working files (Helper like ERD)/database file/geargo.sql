...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 18, 2026 at 05:37 PM
...
(1, 3, '2026-01-04 11:39:24'),
(2, 4, '2026-01-04 13:25:22'),
(3, 1, '2026-01-04 16:47:14');
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `order_status` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `order` (`order_id`, `user_id`, `total_amount`, `order_status`, `shipping_address`, `order_date`) VALUES
(6, 3, 235100, 'Pending', 'abc', '2025-10-01 19:01:44'),
(7, 4, 947300, 'Shipped', 'abc', '2026-01-05 19:03:32'),
(8, 3, 7500, 'Processing', 'abc', '2026-01-05 19:56:49'),
(9, 3, 360200, 'Processing', 'abc', '2026-01-13 20:58:55'),
(10, 3, 414700, 'Processing', 'abc', '2026-01-15 20:59:18'),
(11, 4, 599100, 'Processing', 'abc', '2026-01-18 20:59:58'),
(12, 4, 8400, 'Processing', 'abc', '2026-01-18 21:00:44');
...
INSERT INTO `orderitem` (`order_item_id`, `order_id`, `product_id`, `price_at_purchase`, `quantity`) VALUES
(4, 6, 2, 8800, 2),
(5, 6, 22, 217500, 1),
(6, 7, 46, 135100, 1),
(7, 7, 53, 181100, 1),
...
INSERT INTO `payment` (`payment_id`, `order_id`, `card_id`, `amount`, `payment_status`, `paid_at`) VALUES
(6, 6, 1, 235100, 'Completed', '2026-01-05 19:01:44'),
(7, 7, 2, 947300, 'Completed', '2026-01-05 19:03:32'),
(8, 8, 1, 7500, 'Completed', '2026-01-05 19:56:49'),
(9, 9, 1, 360200, 'Completed', '2026-01-18 20:58:55'),
(10, 10, 1, 414700, 'Completed', '2026-01-18 20:59:18'),
(11, 11, 2, 599100, 'Completed', '2026-01-18 20:59:58'),
(12, 12, 2, 8400, 'Completed', '2026-01-18 21:00:44');
...
(46, 'Pink Fitness Tracker Smartwatch', 'Brighten up your workout routine with this cheerful pink fitness smartwatch. Designed for energy and movement, it features a soft, skin-friendly strap. It monitors your heart rate 24/7 and tracks stress levels to help you maintain wellness. The intuitive interface makes it easy to control music playback and check weather updates on the go. Perfect for those starting their fitness journey.', 'Xiaomi', 'Pink', 135100, 19, 1, 'assets/products/smartwatch collection/10.png', 2, 1),
...
(53, 'Navy Blue Entertainment Tablet', 'Dive into your favorite shows with this navy blue entertainment tablet. It boasts a cinematic wide display that offers an expansive viewing area. The fast processor ensures smooth gaming performance and quick app launches. With Samsung Kids mode, you can create a safe digital environment for your children. The sleek metal body feels premium and is comfortable to hold for hours.', 'Samsung', 'Navy Blue', 181100, 19, 1, 'assets/products/tablet collection/05.png', 5, 1),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `role` enum('admin','customer','staff') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
ALTER TABLE `orderitem`
  ADD CONSTRAINT `orderitem_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`card_id`) REFERENCES `usercard` (`card_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE `usercard`
  ADD CONSTRAINT `usercard_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
