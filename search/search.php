...
if (!empty($search_query)) {
    $data = search_products_by_term($conn, $search_query, $sort_by, $page, $limit);
    $products = $data['products'];
    $totalPages = $data['totalPages'];
} else {
    // If user accessed this page without a search term
    $products = [];
    $totalPages = 0;
}
?>
...
<head>
    ...
    <title>Search Results - GearGo</title>
    ...
    <div class="page-container">
        ...
        <section class="products">
            <div class="products-grid">
                <?php if (count($products) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p style="grid-column: 1/-1; text-align: center; font-size: 1.2rem; color: #666; padding: 40px;">
        ...
        <?php if ($totalPages > 1): ?>
            <div class="pagination">
                ...
                <?php if ($page > 1): ?>
                    <a href="<?php echo $prefix . ($page - 1); ?>">« Prev</a>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a href="<?php echo $prefix . $i; ?>" class="<?php echo ($i == $page) ? 'active' : ''; ?>">
                        <?php echo $i; ?>
                    </a>
                <?php endfor; ?>
